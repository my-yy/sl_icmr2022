from utils import my_parser, seed_util, wb_util, deepcluster_util
from utils.eval_shortcut import Cut
from models import my_model
import torch
from loaders import voxceleb_cluster_ordered_loader
...
def train():
    ...
    for epo in range(args.epoch):
        ...
        # do cluster
        all_keys, all_emb, all_emb_v, all_emb_f = voxceleb_cluster_ordered_loader.extract_embeddings(face_emb_dict, voice_emb_dict, model)
        ...
        # create dataset
        train_iter = voxceleb_loader_for_deepcluster.get_iter(args.batch_size,
